...
function populateVersionInformation(version, valueElement, titleElement, checkElement){
    ...
    if(isPrerelease(version)){
        titleElement.innerHTML = 'Version Beta-Dev'
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/Palifen/PalifenLauncher/releases.atom',
        success: (data) => {
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `Un Nouveau Build ${isPrerelease(data.version) ? 'Pre-release' : 'Release'} Est Disponible`
        ...
        settingsUpdateTitle.innerHTML = 'Vous êtes sur la derniere version'
